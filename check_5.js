...
.receipt-sheet{width:100%;max-width:850px;margin:0 auto;background:#fff;color:#050505;padding:30px 32px 24px;font-family:Arial,'Noto Sans KR',sans-serif;box-sizing:border-box;border:1px solid #bbb}
.receipt-sheet *{box-sizing:border-box}.rs-head{position:relative;border-bottom:3px solid #111;padding:4px 0 22px;min-height:160px}.rs-brand{text-align:center;font-size:24px;font-weight:950;letter-spacing:-1px}.rs-title{text-align:center;font-size:76px;font-weight:950;letter-spacing:24px;line-height:1;margin-top:18px}.rs-order{position:absolute;right:0;top:72px;border:1px solid #111;border-collapse:collapse;font-size:17px}.rs-order td{border:1px solid #111;padding:10px 18px;font-weight:700}.rs-customer-title{display:flex;align-items:center;gap:13px;margin:15px 0 12px}.rs-page-label{background:#050505;color:#fff;padding:10px 18px;border-radius:4px;font-size:22px;font-weight:950}.rs-customer-title strong{font-size:29px;font-weight:950}.rs-subcopy{margin:-7px 0 16px 158px;font-size:14px}.rs-info{border:1.5px solid #222;border-radius:7px;display:grid;grid-template-columns:1fr 1.25fr;margin-bottom:16px;overflow:hidden}.rs-info>div{padding:14px 18px;border-bottom:1px solid #aaa;font-size:16px;min-height:56px;display:flex;align-items:center}.rs-info>div:nth-child(odd){border-right:1px solid #aaa}.rs-info>div:nth-last-child(-n+2){border-bottom:none}.rs-info .label{display:inline-block;min-width:82px;font-weight:950}.rs-info .customer-name{font-size:21px;font-weight:950}.rs-table{width:100%;border-collapse:collapse;table-layout:fixed}.rs-table th{background:#050505;color:#fff;padding:10px;border:1px solid #555;font-size:17px}.rs-table td{border:1px solid #aaa;padding:11px;text-align:center;font-size:16px;height:46px}.rs-table td:nth-child(2){text-align:left}.rs-summary{display:grid;grid-template-columns:1fr 1.05fr;border:1.5px solid #222;border-top:none}.rs-summary>div{padding:14px 22px;line-height:2;font-size:17px}.rs-total{display:flex;align-items:center;justify-content:center;gap:18px;border-left:1px solid #222;font-weight:950;font-size:21px}.rs-total strong{font-size:52px;letter-spacing:1px}.rs-notice{border:1.5px solid #222;border-radius:7px;padding:15px 22px;margin-top:16px;font-size:18px;line-height:1.55}.rs-notice strong{font-size:25px;color:#d01818}.rs-bottom{display:grid;grid-template-columns:1.25fr .75fr;gap:20px;margin-top:18px}.rs-bank{border:1px solid #e5c445;background:#fff7cf;border-radius:7px;padding:14px 18px;font-size:18px;line-height:1.55;margin-top:8px}.rs-bank strong{font-size:28px}.rs-qr{text-align:center;border-left:1px solid #aaa;padding:0 10px}.rs-qr-placeholder{width:112px;height:112px;margin:8px auto 6px;border:7px double #111;display:grid;place-items:center;font-weight:950;font-size:19px}.rs-footer{border-top:2px solid #222;margin-top:18px;padding:14px 8px 0;display:flex;justify-content:space-between;font-size:17px}.rs-tabs{margin-top:18px;border-top:1px dashed #777;padding-top:14px;display:flex;gap:12px;align-items:center}.rs-tab{border:1px solid #777;padding:9px 18px;border-radius:4px;font-size:16px}.rs-tab.active{background:#050505;color:#fff;font-weight:950}.rs-page-note{margin-left:auto;border:1px solid #999;padding:9px 12px;border-radius:4px;font-size:13px;max-width:300px;text-align:center}
@media print{body *{visibility:hidden!important}.receipt-sheet,.receipt-sheet *{visibility:visible!important}.receipt-sheet{position:absolute;left:0;top:0;width:210mm;max-width:none;min-height:297mm;padding:10mm 9mm;border:0}.no-print{display:none!important}@page{size:A4 portrait;margin:0}}
</style>
